...
include_once('all-sessions.php');
?>

<?php
if(!$HopitalId)
 {
  header("Location: http://www.tpadesk.in/");
  exit();
}
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo $finalpath;?>/patient_list.php">Patient List</a></li>
                    <li><a href="<?php echo $finalpath;?>/patient_details.php">Add Patient </a></li>
                   <!-- <li><a href="<?php echo $finalpath;?>/Hospital_Registration_form.php">Hospital Registration Form</a></li>  -->
                    <li><a href="<?php echo $finalpath;?>/pre_auth_form.php">Pre-authorization-form</a></li>
                    <li><a href="<?php echo $finalpath;?>/Query_Reply.php">Query Reply</a></li>
                    <li><a href="<?php echo $finalpath;?>/final-discharge.php">Final Discharge</a></li>
                    <li><a href="<?php echo $finalpath;?>/raise_a_ticket.php">Raise A Ticket</a></li>
                    <li><a href="<?php echo $finalpath;?>/service_request.php">Service Request</a></li>
                    <li><a href="<?php echo $finalpath;?>/payment_due_request.php">Payment Due Request</a></li>
                    <li><a href="<?php echo $finalpath;?>/tpa_empanelment_request.php">TPA Emapanelment Request</a></li>
                </ul>
            </li>
            <!-- <li class="treeview">
                            <a href="#">
